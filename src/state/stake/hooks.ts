...
import { XETHG, xETHG} from '../../constants'
import { STAKING_REWARDS_INTERFACE } from '../../constants/abis/staking-rewards'
import { useActiveWeb3React } from '../../hooks'
import { NEVER_RELOAD, useMultipleContractSingleData } from '../multicall/hooks'
import { tryParseAmount } from '../swap/hooks'

export const STAKING_GENESIS = 1607688900 
...
export function useStakingInfo(pairToFilterBy?: Pair | null): StakingInfo[] {
  ...
  return useMemo(() => {
    ...
    return rewardsAddresses.reduce<StakingInfo[]>((memo, rewardsAddress, index) => {
      ...
      if (
        ...
        const totalRewardRate = new TokenAmount(xethg, JSBI.BigInt(rewardRateState.result?.[0]))
        ...
        memo.push({
          ...
          earnedAmount: new TokenAmount(xethg, JSBI.BigInt(earnedAmountState?.result?.[0] ?? 0)),
  ...
  }, [balances, chainId, earnedAmounts, info, periodFinishes, rewardRates, rewardsAddresses, totalSupplies, xethg])
}
